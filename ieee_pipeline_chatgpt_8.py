#!/usr/bin/env python3
"""
ABUSE-RING SENTINEL - VERSION 8 (FX-Converted & Extended Sweep)
===============================================================
Upgrades:
    1. USD-to-INR Conversion: Scales raw IEEE-CIS USD amounts to INR (₹83.00/$) for realistic Indian BFSI economics.
    2. Extended Threshold Sweep: Sweeps thresholds from 0.001 to 0.95 to eliminate edge-effect limits.
    3. Soft-Confidence Multiplier: Preserves network-aware probability adjustments.
"""
...
MODEL_FILE = "ieee_abuse_ring_sentinel_v8.pkl"
...
USD_TO_INR = 83.00  # Representative exchange rate for Indian BFSI framing
...
# =====================================================================
# MODELING, SOFT CONFIDENCE BOOST & EXTENDED GRID SEARCH
# =====================================================================
...
def calculate_cost_with_soft_boost(y_true, probability, transaction_amount, threshold, features_df=None):
    ...
    # FX Conversion: Scale USD transaction amounts to INR
...
def find_best_threshold_grid_search(y_val, probability, transaction_amount, features_df):
    # Extended candidate thresholds from 0.001 to 0.95
...
def run_pipeline():
    print(f"\n{'=' * 70}\nABUSE-RING SENTINEL V8 (FX-CONVERTED & EXTENDED)\n{'=' * 70}")
